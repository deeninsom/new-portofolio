      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8">
          ...
          <p className="text-2xl md:text-4xl font-bold">
            <span className="text-orange-500">Lviors Jaya Sentosa</span>
          </p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-start gap-6 mb-12">
          ...
          <p className="text-gray-600 max-w-md">
            Based in Surabaya, Indonesia. 2+ years building production-ready apps for real companies. Founder of <a href="https://indevtechsolutions.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-black hover:text-orange-500 transition-colors">Indevtech Solutions</a>.
          </p>
        </motion.div>

        {/* Trusted By Section */}
        <motion.div variants={itemVariants} className="flex flex-col gap-3">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Trusted by</p>
